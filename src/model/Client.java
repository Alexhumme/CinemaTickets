...
/**
 * Clase Cliente para el sistema de boletas de cine
 * Representa la información de un cliente que compra boletas
 */
public class Client {
    // Atributos privados
    ...
    public Client(int id, String name, String lastName, Date birthday, String email) {
        this.id = id;
        this.name = name;
